# v41-32B = v41 파이프라인 + Qwen3-VL-32B-Instruct bf16 (G4 100GB GPU용)
import json

SRC = r"C:\Users\pak10\Downloads\colab_v31_grounding_off.ipynb"
OUT = r"c:\Pyg\Projects\dacon\SKKU-Multimodal-Challenge-2026\colab_v41_32b.ipynb"
...
# ────────────────────────────────────────────
INTRO = """# v41-32B — Qwen3-VL-32B-Instruct bf16 + v41 파이프라인

**모델:** Qwen3-VL-32B-Instruct (bf16 풀정밀도, ~65GB VRAM)
**GPU:** G4 100GB 이상 권장. A6000 48GB에서는 AWQ 양자화 필요.
...
**시간:** 32B는 9B 대비 ~3-4배 느림. 전체 ~1.5시간 예상.
**산출:** `outputs/submission_v41_32b.csv` + 분석 차트.
**실행:** 셀0 설치→재시작→순서대로.
"""
...
CHART_DIR=f'{PROJECT}/outputs/charts_v41_32b'
...
fig.suptitle('v41-32B Pipeline Waterfall (Qwen3-VL-32B bf16)',fontsize=14,fontweight='bold')
...
checks = [
    ...
    ("VER=v41_32b", "v41_32b" in FINAL_CMP),
    ("v40 비교 있음", "v40" in FINAL_CMP),
    ("차트 v41_32b", "charts_v41_32b" in ANALYSIS),
